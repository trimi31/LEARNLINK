...
const Footer = () => {
  ...
  const footerLinks = {
    platform: [
      { name: 'Find Professors', to: '/professors' },
      { name: 'Browse Courses', to: '/courses' },
      { name: 'Become a Professor', to: '/register' },
      ...
      <div className="footer-container">
            ...
            <div className="footer-brand-logo">
              <div style={{
                ...
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <path d="M6 20V8L18 14L6 20Z" fill="currentColor"/>
                </svg>
              </div>
              <span>LearnLink</span>
            </div>
            <p className="footer-brand-text">
              Connecting students with expert educators worldwide. 
        ...
        <div className="footer-bottom">
          <p className="footer-copy">
            © {currentYear} LearnLink. All rights reserved.
          </p>
          <div style={{ 
            display: 'flex', 
            alignItems: 'center', 
